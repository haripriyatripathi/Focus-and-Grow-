      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 rounded-full border border-gray-200 bg-gray-50 p-1 dark:border-gray-700 dark:bg-gray-800">
            <button
                onClick={toggleTheme}
                className="flex h-8 w-8 items-center justify-center rounded-full text-gray-600 transition-colors hover:bg-white hover:shadow-sm dark:text-gray-400 dark:hover:bg-gray-700"
